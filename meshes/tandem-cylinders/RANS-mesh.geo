...
// Mesh Resolution
n_arch = 20; //# on 1/4 cylinder surface
n_norm = 20; //# on mesh diagonals normal to cylinder
n_span = 20; //# of points on Y parallel lines
n_xInlet = 20; //# of points on X parallel inlet lines
n_xOutlet = 50; //# of points on X parallel inlet lines
n_z = 50;
//
p_norm = 1.05;
p_span = 1.1;
