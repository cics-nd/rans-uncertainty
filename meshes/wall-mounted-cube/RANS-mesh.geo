...
//Front X+ Progression
Transfinite Line {6, -8, 10, 13} = gs Using Progression 0.9057255027;
Transfinite Line {45, 40, 33, 36} = gs Using Progression 0.9057255027;
Transfinite Line {85, 80, 73, -76} = gs Using Progression 0.9057255027;

// Back X- Progression
Transfinite Line {23, -21, -25, -27} = 2*gs Using Progression 0.9345152035;
Transfinite Line {58, 61, 64, 67} = 2*gs Using Progression 0.9345152035; 
Transfinite Line {103, -99, -94, -91} = 2*gs Using Progression 0.9345152035;

// Z Progression
Transfinite Line {5, -7, -16, -22, 28, -19, 14, -12} = gs Using Progression 0.9057255027; // Bottom Y
Transfinite Line {68, 60, 55, 50, 31, 43, 46, 35} = gs Using Progression 0.9057255027; // Middle Y
Transfinite Line {93, -89, 86, -83, -71, 75, -101, -104} = gs Using Progression 0.9057255027; // Top Y
